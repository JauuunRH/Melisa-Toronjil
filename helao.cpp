...
int main()
 {
system("color e9");
Helado ice_cream[3]={Helado("Fresa",10.00,"cono"),Helado("Chocochispas",70.00,"vaso"),Helado("Napolitano",15.00,"cono")};
for(int i=0;i<=2;i++)
 	{
cout<<ice_cream[i].getSabor()<<endl;
cout<<ice_cream[i].getPrecio()<<" pesos."<<endl;
